...
public class TestPuzzle16 extends BasePuzzleTest {
  ...
  public void testPart1Example1() {
    ...
    Assert.assertEquals(Puzzle16.fft(signal), List.of(4, 8, 2, 2, 6, 1, 5, 8));
  }

  @Test
  public void testPart1Example2() {
    List<Integer> signal = List.of(4, 8, 2, 2, 6, 1, 5, 8);
    Assert.assertEquals(Puzzle16.fft(signal), List.of(3, 4, 0, 4, 0, 4, 3, 8));
  }

  @Test
  public void testPart1Example3() {
    List<Integer> signal = List.of(3, 4, 0, 4, 0, 4, 3, 8);
    Assert.assertEquals(Puzzle16.fft(signal), List.of(0, 3, 4, 1, 5, 5, 1, 8));
  }

  @Test
  public void testPart1Example4() {
    List<Integer> signal = List.of(0, 3, 4, 1, 5, 5, 1, 8);
    Assert.assertEquals(Puzzle16.fft(signal), List.of(0, 1, 0, 2, 9, 4, 9, 8));
  }
